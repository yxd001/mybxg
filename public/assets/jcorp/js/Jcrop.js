  ...
  $.extend(Thumbnailer,{
    ...
    prototype: {
      ...
      insertElements: function(){
        ...
        this.element = $('<div />').addClass('jcrop-thumb')//动态创建了一个div标签，存在内存中，
          .width(this.width).height(this.height)//设置预览区域的宽高
          .append(this.preview)//缩略图
          .appendTo(($(this.mythumb).size==0?null:$(this.mythumb)) || this.core.container);//追加到外层的大容器中
      },
      resize: function(w,h){
        this.width = w;
        this.height = h;
